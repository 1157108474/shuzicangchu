...
public class MaterialYKYWOutStoreAdapter extends BaseAdapter {
    //
    ...
    */
    public MaterialYKYWOutStoreAdapter(Context context, List<Material> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        MaterialYKYWOutStoreAdapter.ViewHolder holder = null;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_adapter_material_ykyw_outstore, parent, false);
            holder = new MaterialYKYWOutStoreAdapter.ViewHolder();
            ...
            holder = (MaterialYKYWOutStoreAdapter.ViewHolder) convertView.getTag();
        }
