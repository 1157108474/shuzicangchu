package com.example.admin.storage.views;
...
public class PullToRefreshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private final int LOAD_MORE = 3; // 需加载
    private final int LOADING_MORE = 4; // 正在加载更多
    private final int NOMAL_LOAD = 5; // 需加载//
...
//                int paddingBottom = footerViewHeight + diff;
                if (isScrollToBottom && diff<-40  && !isLoadingMore && isLoadMore() && currentState != REFRESHING && currentState != LOADING_MORE ) {
