...
public class MaterialHasIntoStoreAdapter extends BaseAdapter {
    //
    ...
    */
    public MaterialHasIntoStoreAdapter(Context context, List<Material> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        MaterialHasIntoStoreAdapter.ViewHolder holder = null;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_adapter_material_hasintostore, parent, false);
            holder = new MaterialHasIntoStoreAdapter.ViewHolder();
            ...
            holder.intoNum_tv = (TextView) convertView.findViewById(R.id.id_into_num);
            ...
            holder = (MaterialHasIntoStoreAdapter.ViewHolder) convertView.getTag();
        }
        ...
        holder.intoNum_tv.setText(material.getPutawayNum());
