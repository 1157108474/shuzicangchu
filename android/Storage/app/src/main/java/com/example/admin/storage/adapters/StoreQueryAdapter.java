...
public class StoreQueryAdapter extends BaseAdapter {
    //
    ...
    */
    public StoreQueryAdapter(Context context, List<Material> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        StoreQueryAdapter.ViewHolder holder = null;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_adapter_store_query, parent, false);
            holder = new StoreQueryAdapter.ViewHolder();
            ...
            holder.mOwner_tv = (TextView) convertView.findViewById(R.id.id_owner);
//            holder.mSerial_tv = (TextView) convertView.findViewById(R.id.id_serial);
            ...
            holder = (StoreQueryAdapter.ViewHolder) convertView.getTag();
        }
...
//        holder.mSerial_tv.setText(material.getSerial());
        ...
        holder.mOwner_tv.setText(material.getOwner());
        return convertView;
