namespace EWMS.Entity
{
    ...
    [Serializable, Table(TableName="WZ_SheetCKSubDetail", PrimaryField="ID", IdentityField="", Order="AddTime DESC", IgnoreInsertFields="", IgnoreUpdateFields="")]
    public class WZ_SheetCKSubDetail : BaseEntity
    {
