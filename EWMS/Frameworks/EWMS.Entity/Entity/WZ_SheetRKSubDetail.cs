namespace EWMS.Entity
{
    ...
    [Serializable, Table(TableName="WZ_SheetRKSubDetail", PrimaryField="ID", IdentityField="", Order="AddTime DESC", IgnoreInsertFields="", IgnoreUpdateFields="")]
    public class WZ_SheetRKSubDetail : BaseEntity
    {
