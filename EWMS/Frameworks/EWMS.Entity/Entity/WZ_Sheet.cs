namespace EWMS.Entity
{
    ...
    [Serializable, Table(TableName="WZ_Sheet", PrimaryField="ID", IdentityField="", Order="CreateDate DESC", IgnoreInsertFields="", IgnoreUpdateFields="")]
    public class WZ_Sheet : BaseEntity
    {
