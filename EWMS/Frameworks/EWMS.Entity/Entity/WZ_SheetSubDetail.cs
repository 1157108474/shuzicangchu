namespace EWMS.Entity
{
    ...
    [Serializable, Table(TableName="WZ_SheetSubDetail", PrimaryField="ID", IdentityField="", Order="AddTime DESC", IgnoreInsertFields="", IgnoreUpdateFields="")]
    public class WZ_SheetSubDetail : BaseEntity
    {
