namespace EWMS.Entity
{
    ...
    [Serializable, Table(TableName="WZ_SHEET_RK", PrimaryField="ID", IdentityField="", Order="CreateDate DESC", IgnoreInsertFields="", IgnoreUpdateFields="")]
    public class WZ_SHEET_RK : BaseEntity
    {
