namespace EWMS.Entity
{
    ...
    [Serializable, Table(TableName="WZ_SheetDetail", PrimaryField="ID", IdentityField="", Order="CreateDate DESC", IgnoreInsertFields="", IgnoreUpdateFields="")]
    public class WZ_SheetDetail : BaseEntity
    {
