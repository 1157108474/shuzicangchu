namespace EWMS.Entity
{
    ...
    [Serializable, Table(TableName="WZ_PDDetail", PrimaryField="ID", IdentityField="", Order="ID DESC", IgnoreInsertFields="", IgnoreUpdateFields="")]
    public class WZ_PDDetail : BaseEntity
    {
        ...
        public decimal SysCount { get; set; }
