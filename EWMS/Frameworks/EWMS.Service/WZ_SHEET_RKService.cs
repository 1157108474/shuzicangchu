namespace EWMS.Service
{
    ...
    public class WZ_SHEET_RKService : BaseService<WZ_SHEET_RK>
    {
        private static readonly WZ_SHEET_RKService _Instance = new WZ_SHEET_RKService();
        ...
        public List<Base_Dictionary> GetAllDic()
        {
            ...
            List<Base_Dictionary> objObject = Base_DictionaryService.Instance.GetList(sql);
            cacheHelper.Base_Page.SetCache("dataDicList", objObject, DateTime.MaxValue, TimeSpan.FromMinutes(20.0));
            return objObject;
        }

        public int InsertData(WZ_SHEET_RK sheet, int creator, string kindcode, Base_Menu menu)
        {
            string str = "WZSHEETRK_SEQUENCE";
            try
            {
        ...
        public static WZ_SHEET_RKService Instance
        {
            get
            {
                return _Instance;
