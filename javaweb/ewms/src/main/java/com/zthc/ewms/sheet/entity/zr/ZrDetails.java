package com.zthc.ewms.sheet.entity.zr;
 ...
 */
@Entity
@Table(name = "v_zrdetails")
public class ZrDetails {
     ...
     * ----库房名称---
     **/
    @Column(name = "name", columnDefinition = "nvarchar2(255) NULL COMMENT '库房name名称'")
    private String name;
    /**
     * ----库房名称---
     **/
    ...
    public String getExtendFloat1Double() {
        return NumberUtils.getDouble(extendFloat1);
    }
