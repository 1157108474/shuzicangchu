 ...
 */
@Entity
@Table(name="WZ_ORDERINFO")
public class SheetCG {

	/**----id---**/
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "generator")
	@SequenceGenerator(name= "generator",sequenceName = "WZ_ORDERINFO_SEQUENCE",allocationSize = 1)
	...
	/**----基本单位含税单价---**/
	@Column(name="baseunittaxprice", columnDefinition="number(18,9) NULL COMMENT '基本单位含税单价'")
	private Double baseunittaxprice;
	...
	public void setErprownum(String erpownum) {
	...
	public Double getBaseunittaxprice() {
		return baseunittaxprice;
	}

	public void setBaseunittaxprice(Double baseunittaxprice) {
		this.baseunittaxprice = baseunittaxprice;
	}
