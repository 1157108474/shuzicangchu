 ...
 */
@Entity
@Table(name = "V_TKD_PRINT")
public class TKPrint {
    @Id
     ...
     * ----领用部门---
     **/
    @Column(name = "APPLYDEPNAME", columnDefinition = "nvarchar(200) NULL COMMENT '领用部门'")
...
//    private String url;
    ...
    public Double getExtendString1() {
        return extendString1;
    }

    public void setExtendString1(Double extendString1) {
