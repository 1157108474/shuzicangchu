...
public class SheetJCRK {
	...
	public SheetJCRK(String guid, String name, String code, Integer kindId, Integer typeId, String dutyId, Integer departId, Integer routeId, Integer routeStepId, Integer roleId, Integer relateSheet, Integer submitManId, Date submitTime, Integer status, String memo, Integer creator, Date createDate, Integer ztId, Integer ownerDep, String url, String ownerDepName, String personName, String statusName, String depName) {
		this.guid = guid;
		this.name = name;
		this.code = code;
		this.kindId = kindId;
