...
<div id="formbody" class="formbody">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block form-label">
                                        <div style="float: left;width: 80px">
                                            <input type="text"  class="layui-input startTime" id="begin" name="begin"
                                                   placeholder="yyyy-MM-dd">
                                        </div>
                                        <div style="width: 20px;float: left;text-align: center;">至</div>
                                        <div style="float: left;width: 80px">
                                            <input type="text"  class="layui-input endTime" id="end" name="end"
                                                   placeholder="yyyy-MM-dd">
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="layui-collapse" lay-filter="test">
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                <table id="jcwzckgrid" lay-filter="jcwzckgrid"></table>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="/js/sheet/jcwzck/manageJcWzck.js"></script>
