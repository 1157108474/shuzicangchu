                ...
                <form class="layui-form " action="">
                    <table>
                            ...
                            <td>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block" style="position:relative;">
                                        ...
                                        <input class="layui-input" name="creator" id="creatorId" type="hidden">
                        ...
                        <tr>
                            ...
                            <td>
                                <button style="margin-left: 30px" class="layui-btn bill-td-button " type="reset"
                                        id="reset">重置
                                </button>
                            </td>
                        </tr>
...
<script type="text/javascript" src="/js/sheet/zc/manageZc.js"></script>
