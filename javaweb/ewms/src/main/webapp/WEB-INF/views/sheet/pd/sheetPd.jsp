    ...
    <div id="km_toolbar" class="mini-toolbar" style="height:20px;">
        ...
        <div style="float:right">
            ...
            <span style="padding-left:10px;">
                单据编号：<label id="code">${code}</label>
                制单部门：<label>${depart}</label>
                制单人：<label>${creator}</label>
                制单时间：<label id="date">${createDate}</label>
            </span>
                        ...
                        <tr>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" class="layui-input"
                                               id="extendString1" name="extendString1" value="" disabled="disabled">
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block" id="extendInt2Div">
                            ...
                            <td>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" class="layui-input" id="memo" name="memo" value="" disabled="disabled">
                                    </div>
                                </div>
                            </td>
                        </tr>
