...
<div id="formbody" class="formbody">
    ...
    <div id="llSheetHead" class="layui-collapse" lay-filter="test">
        <div class="layui-colla-item">
            <h2 class="layui-colla-title">寄存物资出库单</h2>
                            ...
                            <td>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block" style="position:relative;">
                                        ...
                                        <input class="layui-input" id="ownerdepId" type="hidden" value="${sheet.ownerDep}">
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="layui-form-item">
                                    <label class="layui-form-label"><font color="red">* </font>领料人:</label>
                                    <div class="layui-input-block" style="position:relative;">

                                        <input type="text" class="layui-input" id="useName" value="${sheet.useName}">
                                        <button class="layui-btn bill-button" id="usedManBtn">...</button>
                                        <input class="layui-input" id="usedManId" type="hidden" value="${sheet.usedManId}">
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="layui-form-item">
                                    <label class="layui-form-label"><font color="red">* </font>保管员:</label>
                                    <div class="layui-input-block" style="position:relative;">

                                        <input type="text" class="layui-input" id="storeManName" value="${sheet.storeManName}">
                                        <button class="layui-btn bill-button" id="storeManBtn">...</button>
                                        <input class="layui-input" id="storeManId" type="hidden" value="${sheet.storeManId}">
                                    </div>
                                </div>
                            </td>
                            <td >
...
<script type="text/javascript" src="/js/sheet/jcwzck/jcwzck.js"></script>
