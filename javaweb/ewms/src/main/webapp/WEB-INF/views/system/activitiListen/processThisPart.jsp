...
<div class="admin-main">
	<div style="margin-left: 10%;float: left;width:78%;margin-top: 10px;">
				...
				<div class="layui-colla-item">
					...
					<div class="layui-colla-content layui-show" style="padding:0px;">
						<%--<table  id="partUser" lay-filter="partUser" style="margin-top: -10px"></table>--%>
							...
							<div id="demo1" style="float: right"><input id="userCount" type="hidden" value="${count}"></div>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="<%=path%>/js/system/act/processThisPart.js"></script>
...
<script>
    ...
    $("#gotoNext").click(function () {
        ...
        if(userId != undefined){
            ...
            $.post("setAssigneeTask.htm",{'userId':userId,'taskId':taskId},
                function(data) {
                	if(data){
                        layer.alert(
                            "另派成功",
