            ...
            <form class="layui-form " action="">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="bill-td">
                            <button style="margin-left: 70px" class="layui-btn layui-btn-warm bill-td-button" lay-submit
                                    lay-filter="formSubmit">查询
                            </button>
...
<script type="text/javascript" src="<%=path %>/js/system/act/activitiProcessing.js"></script>
