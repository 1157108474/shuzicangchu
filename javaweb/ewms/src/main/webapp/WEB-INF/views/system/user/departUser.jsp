...
<div class="admin-main">
    <div  style="margin:10px 10px;height:100%;"  >
        <div  style="float:left;border:1px solid #617775;width:320px;position:absolute; height:95%; overflow-y:auto"  >
...
<script type="text/javascript" src="/js/system/user/departUser.js"></script>
<!--用户状态-->
