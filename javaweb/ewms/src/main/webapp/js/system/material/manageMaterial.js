...
//            otherParam:{"ran":ran++},
    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{field:'description',align: 'center', title:'物料描述',width:390,fixed: 'left'}
            /*,{field:'price',align: 'center', title:'单价',width:50}*/
            ,{field:'unit',align: 'center', title:'单位',width:50}
            ,{field:'stockUp',align: 'center', title:'库存上限',width:75}
            ,{field:'stockDown',align: 'center', title:'库存下限',width:75}
            , {
                field: 'enableSN',
                title: '启用序列',
                width:75,
