layui.use(['laydate', 'form', 'table', 'layer','element'], function () {
    ...
    table.render({
        ...
        , url: 'listUseDepGeneral.json?id=' + uid + "&ztId=" + ztId  //数据请求路径
        ,cellMinWidth: 80
        ,method:'post'
        ,cols: [[
            ...
            , {
                field: 'organizationType', align: 'center', title: '组织类型', width: 100, templet: function (d) {
