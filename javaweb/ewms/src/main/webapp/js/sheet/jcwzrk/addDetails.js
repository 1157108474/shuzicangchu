...
function setMaterialInfo(data) {
    ...
    document.getElementById("materialSpecification").value = data.specifications;//规格
    document.getElementById("materialModel").value = data.models;//型号
    document.getElementById("detailUnitName").value = data.unit;
    document.getElementById("description").value = data.description;
    document.getElementById("materialBrand").value = data.brand;//品牌
}
function sumAmount(){
